<?php 
    ...
    if (isset($_GET['food_id']) && !empty($_GET['food_id'])) {
        ...
        if ($count_food == 1) {
            ...
            $sql_check_cart = "SELECT * FROM tbl_cart_items WHERE cart_id='$user_id' AND food_id='$food_id'";
            ...
            if ($count_check_cart > 0) {
                ...
                $sql_update_cart = "UPDATE tbl_cart_items SET quantity='$new_quantity' WHERE cart_id='$user_id' AND food_id='$food_id'";
            ...
            else 
            {
                ...
                $sql_insert_cart = "INSERT INTO tbl_cart_items (cart_id, food_id, quantity) VALUES ('$user_id', '$food_id', '1')";
