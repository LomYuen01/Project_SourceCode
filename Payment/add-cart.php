                    ...
                    <div class="col-md-9" style=" margin-left: 10%;">
                        ...
                        <div style="display: flex; flex-direction: row; justify-content: start;flex-direction: column;">
                            ...
                            while ($row_category = mysqli_fetch_assoc($res_category)) {
                                ...
                                $sql_food = "SELECT * FROM tbl_food WHERE category_id=$category_id AND active='Yes' AND id=$food_id";
                                    ...
                                    <form action="#" method="POST">
                                        <div class="food-menu-box"
                                            ...
                                            <h4 id="<?php echo $category_id; ?>"
                                                ...
                                                ?>
                                                <div class="food-menu-box"
                                                    style="display: flex; width:100%;  padding-bottom:5%; margin-left: -20px; margin-right: -20px;">
                                                    <div class="food-menu-desc" style="flex: 0 0 60%;">
                                                        ...
                                                        <?php
                                                            $sql = "SELECT id,name, active FROM tbl_food_variation WHERE food_id = $food_id AND active = 'Yes'";
                                                    ...
                                                    <div class="food-menu-img"
                                                        ...
                                                        ?>
                                                            <div>
                                                                <img src="<?php echo SITEURL; ?>images/food/<?php echo $food_image; ?>"
                                                                    ...
                                                                    style="width: 70%; height: 70%; object-fit: contain; margin-left: 15%; margin-bottom: 15px;">
                                                            </div>
                                                        <?php 
                                                        } 
                                                        ?>
                                                        <div>
                                                            ...
                                                            <input type="submit" name="submit" value="Add to Cart" class="btn btn-primary"
                                                                style="display: block; margin: auto; width: 70%; border: 1px solid; border-radius: 18px; color:var(--sk-body-link-color, #06c); text-align: center; font-size: 1em;">
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php 
...
ob_start();
    if(isset($_POST['submit']))
    {
        ...
        $customer_id = isset($_SESSION['user']['user_id']) ? $_SESSION['user']['user_id'] : "";
