...
<html>
    ...
    <body>
        <header class="header">
            <nav class="nav">
                <a href="#" class="image-text" style="margin-left: -7.5%;"> 
                    <span class="image">
                ...
                <ul class="nav-items">
                    <li class="nav-item">
                        <a href="<?php echo SITEURL; ?>index.php" class="nav-link">Home</a>
                ...
                <?php 
                    ...
                    ?>
                        ...
                        <div class="sub-menu-wrap" id="subMenu">
                            <div class="sub-menu" style="padding-bottom: 12px;">
                                <div class="user-info">
                                    <img src="<?php echo $current_image != "" ? SITEURL."images/Profile/".$current_image : 'images/no_profile_pic.png'; ?>">
                                    <h3 style="color: #000;"><?php echo $full_name ?></h3>
                                </div>

                                <!-- LINEEEEEEEE --> <hr> <!-- LINEEEEEEEE -->

                                <a href="<?php echo SITEURL; ?>edit-profile.php?id=<?php echo $_SESSION['user']['user_id']; ?>" class="sub-menu-link">
                                    <i class='bx bxs-user-circle icon'></i>
                                    <p>Edit Profile</p>
                                    <span>></span>
                                </a>

                                <a href="<?php echo SITEURL; ?>change-password.php" class="sub-menu-link">
                                    <i class='bx bx-lock icon'></i>
                                    <p>Change Password</p>
                                    <span>></span>
                                </a>

                                <a href="<?php echo SITEURL; ?>logout.php" class="sub-menu-link">
