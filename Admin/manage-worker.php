<?php include('Partials/menu.php'); ?>
    ...
    <section class="home">
        <div class="title">
            <div class="text">Manage Worker Details</div>
        ...
        <div class="table">
            ...
            <section class="table-header">
                ...
                <div class="dropdown-toggle-column">
                    ...
                    <ul class="menu-column" style="width: 200px; font-size: 12px;">
                        <li>
                            ...
                            <label><input type="checkbox" class="checkbox-column" data-column="4" checked/>&nbsp; Email &nbsp; </label> <br>
                            <label><input type="checkbox" class="checkbox-column" data-column="5" checked/>&nbsp; Position &nbsp; </label> <br>
                ...
                <div class="input-group" style="margin-left: 46px;">
                ...
                <div class="add-food">
                    <label for="dropdown-nav-bar" class="add-btn">
                        ...
                        <?php echo "<a href=\"".SITEURL."admin/add-worker.php\"><span class=\"icon-text\">Add Worker</span></a>" ?>
                    </label>
                </div>
            </section>
            <!-- =================================================== Header Section =================================================== -->
                    ...
                    <thead>
                        <tr>
                            ...
                            <?php if ($position == 'Superadmin') { ?>
                                <th style="padding-right: 1.55rem;"> Actions <span class="icon-arrow"></span></th>
                            <?php } echo "<th></th>"; ?>
                        </tr>
                    </thead>
                    <tbody>
                                ...
                                if($count > 0)
                                {
                                    ...
                                    while($rows = mysqli_fetch_assoc($res))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td class="buttons"  style="padding-right: 1.55rem;"> 
                                                <a href="<?php echo SITEURL; ?>admin/view-worker.php?id=<?php echo $id; ?>&address_id=<?php echo $address_id; ?>" style="width: 40px; font-size: 14px;" class="btn-primary" title="View details"><i class='bx bx-search-alt'></i></a>
                                                <a href="<?php echo SITEURL; ?>Admin/update-worker.php?id=<?php echo $id; ?>&address_id=<?php echo $address_id; ?>" style="width: 40px; font-size: 14px;" class="btn-secondary" title="Update details"><i class='bx bxs-edit'></i></a>
                                            </td>
                                        </tr>
