<?php include('Partials/menu.php'); ?>
    ...
    <section class="home">
        <div class="title">
            <div class="text">Manage Driver Details</div>
        </div>
        ...
        <div class="table">
            ...
            <section class="table-header">
                ...
                <div class="input-group" style="margin-left: 43.5px;">
                ...
                <div class="add-food">
                    <label for="dropdown-nav-bar" class="add-btn">
                        ...
                        <?php echo "<a href=\"".SITEURL."admin/add-driver.php\"><span class=\"icon-text\">Add Driver</span></a>" ?>
                    </label>
                </div>
            </section>
            <!-- =================================================== Header Section =================================================== -->
                    ...
                    <thead>
                        <tr>
                            ...
                            <?php if ($position == 'Superadmin') { ?>
                                <th style="padding-right: 3rem;"> Actions <span class="icon-arrow"></span></th>
                            <?php } echo "<th></th>"; ?>
                        </tr>
                    </thead>
                    <tbody>
                                    ...
                                    while($rows = mysqli_fetch_assoc($res))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td class="buttons" style="padding-right: 3rem;"> 
                                                <a href="<?php echo SITEURL; ?>admin/view-driver.php?id=<?php echo $id; ?>&address_id=<?php echo $address_id; ?>" style="width: 40px; font-size: 14px;" class="btn-primary" title="View details"><i class='bx bx-search-alt'></i></a>
                                                <a href="<?php echo SITEURL; ?>Admin/update-driver.php?id=<?php echo $id; ?>&address_id=<?php echo $address_id; ?>" style="width: 40px; font-size: 14px;" class="btn-secondary" title="Update details"><i class='bx bxs-edit'></i></a>
                                            </td>
                                        </tr>
