<?php
    ...
    if ($mysqli->affected_rows) {
        ...
        <p>We received a request to reset your password for your admin account. Click the link below to reset your password:</p>

        <p><a href="http://localhost/RenoKitchen/admin/Email/reset-password.php?token=$token">Reset Password</a></p>
