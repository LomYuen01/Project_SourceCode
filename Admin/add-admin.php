...
<script src="https://kit.fontawesome.com/3bfb2b9d7b.js" crossorigin="anonymous"></script>
    <section class="home">
        ...
        <div class="form-container" style="overflow: visible;">
            <!-- =================================================== Form Section =================================================== -->
                <form id="add-admin-form" action="" method="POST" enctype="multipart/form-data" style="background: none; box-shadow: none;">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            addAdminForm.addEventListener('submit', (event) => {
                ...
                formData.append('submit', 'Add Admin');

                fetch('Process/process-add-admin.php', {
                    method: 'POST',
                    body: formData
                })
                .then(response => {
